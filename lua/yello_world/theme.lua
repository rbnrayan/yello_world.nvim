...
theme.set_highlights = function ()
  ...
  hl(0, "DiagnosticUnderlineError", { fg = c.fg, sp = c.error, undercurl = true })
  hl(0, "DiagnosticUnderlineWarn", { fg = c.fg, sp = c.warning, undercurl = true })
  hl(0, "DiagnosticUnderlineInfo", { fg = c.fg, sp = c.white, undercurl = true })
  hl(0, "DiagnosticUnderlineHint", { fg = c.fg, sp = c.green, undercurl = true })
  hl(0, "DiagnosticUnderlineVirtualTextError", { fg = c.fg, sp = c.error, undercurl = true })
  hl(0, "DiagnosticUnderlineVirtualTextWarn", { fg = c.fg, sp = c.warning, undercurl = true })
  hl(0, "DiagnosticUnderlineVirtualTextInfo", { fg = c.fg, sp = c.white, undercurl = true })
  hl(0, "DiagnosticUnderlineVirtualTextHint", { fg = c.fg, sp = c.green, undercurl = true })
